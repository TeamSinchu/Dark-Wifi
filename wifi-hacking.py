###########################################################################
# AUTHOR  : CLASSY_SINCHANA                                               #
#  TIP     : FUCK YOU HATERS
###########################################################################

# Coader/@_team_sinchuu_07_
#!/usr/bin/env python3
...
716)install all wireless tools
""")
        ...
        print("""
Hi.
My Name classy_sinchana , A Ethical Hacker,Bug Bounty Hunter,Currently Working as Cyber Security Researcher.
you can find on INSTAGRAM !

https://www.instagram.com/classy_sinchana?igsh=NTc4MTIwNjQ2YQ==

Contack me = @_team_sinchuu_07_
